...
class SequencePredictor:
    def __init__(self, window_size=12, ensemble_size=4):
        ...
        Args:
            window_size: Number of previous sequences to consider for prediction (increased to 12)
            ensemble_size: Number of different models in ensemble (increased to 4 with XGBoost)
        """
